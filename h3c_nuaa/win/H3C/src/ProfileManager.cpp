...
ProfileManager::ProfileManager(const tstring& iniFilePath)
:iniProcessor(iniFilePath)
{
	Init();
}
...
ProfileManager* ProfileManager::GetProfileManager(const tstring& iniFilePath)
{
...
void ProfileManager::Save()
{
	...
	newSettings["real_ip"] = realIp ? IniValue(string("1")) : IniValue(string("0"));
